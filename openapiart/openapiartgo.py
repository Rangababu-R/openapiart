...
class OpenApiArtGo(OpenApiArtPlugin):
    ...
    def _write_interface(self, new):
        ...
        self._write(
            ...
            func (obj *{struct}) validateFromText(path string) error {{
        ...
        interfaces = [
            ...
            "// A stringer function",
            "String() string",
            "validateFromText(path string) error",
            "validateObj(set_default bool, path string)",
            "setDefault()",
        ]
        for field in new.interface_fields:
    ...
    def _write_validate_method(self, new):
        ...
        body = "\n".join(statements)
        self._write(
            """func (obj *{struct}) validateObj(set_default bool, path string) {{
                if set_default {{
                    obj.setDefault()
                }}
                {body}
